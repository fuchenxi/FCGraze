...
- (void)sendRequest:(FCRequest *)request completionHandler:(FCCompletionHandler)completionHandler {
    ...
    } else if (request.requestType == kFCRequestTypeUpload) {
        
        [self fc_uploadTaskWithRequest:request completionHandler:completionHandler];
    }
}
...
- (void)fc_uploadTaskWithRequest:(FCRequest *)request completionHandler:(FCCompletionHandler)completionHandler {
    ...
    [requestSerializer multipartFormRequestWithMethod:@"POST"
                            ...
                            constructingBodyWithBlock:^(id<AFMultipartFormData>  _Nonnull formData) {
                                ...
                                [request.uploadFormDatas enumerateObjectsUsingBlock:^(FCUploadFormData * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
    ...
    [self fc_setIdentifierForRequest:request taskIdentifier:uploadTask.taskIdentifier sessionManager:sessionManager];
